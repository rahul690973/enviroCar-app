...
public class HalfViewWidthImageView extends ImageView implements
		OnParentDrawnListener {
	...
	private void parseAttributes(AttributeSet attrs) {
		relatedLayoutId = attrs.getAttributeResourceValue(NAMESPACE,
				RELATED_VIEW_KEY, Integer.MIN_VALUE);
	}
	...
	private int resolveRootViewWidth() {
		...
		if (result == null) {
			throw new IllegalStateException(
					"Related root layout not resolvable.");
		}
